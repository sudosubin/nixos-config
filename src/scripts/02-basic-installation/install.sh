...
msg_normal "make zsh default shell"
...
msg_normal "make nimf default im"
im-config -n nimf
...
msg_normal "build capitaine-cursors"
cd temp-git || exit
mute ./build.sh -t dark
cd ..

### Build softwares: capitaine-cursors copy
msg_normal "copy to cursors path"
...
msg_normal "build window-decoration"
